    ...
    for im in tqdm(pics):
        ...
        for i, boxes in enumerate(result_, 1):
            if len(boxes):
                ...
                for box in boxes:
                    anno = {}
                    anno['image_id'] = os.path.basename(im).split('.')[0]
...
## 脚本文件
```
python ./submit.py -m /home/******/mm_workdir/cascade_rcnn_r50_fpn_1x/epoch_66.pth -c configs/cascade_rcnn_r50_fpn_1x.py -im /home/******/val/images_withoutrect -o /home/******/mm_workdir/cascade_rcnn_r50_fpn_1x/submit.json
```
